...
p1<-
  ggplot(dff,aes(collcode,fill=parents_college)) +
...
q2<-ggplot(dff,aes(collcode,fill=y_collcode))+geom_bar(position="fill")
...
yc_q80 + theme(axis.text.x=element_text(angle=60,hjust=1))
```
